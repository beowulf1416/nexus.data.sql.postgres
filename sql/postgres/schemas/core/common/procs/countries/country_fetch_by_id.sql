create or replace function country_fetch_by_id(
    p_country_id countries.iso_3166_1_numeric%type
)
returns table (
...
begin
    ...
    where
        a.iso_3166_1_numeric = p_country_id
    ;
end
$$;


comment on function country_fetch_by_id is 'get country record';